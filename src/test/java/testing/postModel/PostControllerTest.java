...
class PostControllerTest {
    ...
    void setUp() {
        posts = List.of(
                new Post(1L,1,"Hello, World!", "This is my first post.",null),
                new Post(2L,1,"Second Post", "This is my second post.",null)
        );
    }
    ...
    void shouldFindPostWhenGivenValidId() throws Exception {
        Post post = new Post(1L,1,"Test Title", "Test Body",null);
    ...
    void shouldCreateNewPostWhenGivenValidID() throws Exception {
        Post post = new Post(3L,1,"This is my brand new post", "TEST BODY",null);
    ...
    void shouldUpdatePostWhenGivenValidPost() throws Exception {
        Post updated = new Post(1L,1,"This is my brand new post", "UPDATED BODY",1);
    ...
    void shouldNotUpdateAndThrowNotFoundWhenGivenAnInvalidPostID() throws Exception {
        Post updated = new Post(50L,1,"This is my brand new post", "UPDATED BODY",1);
        when(repository.save(updated)).thenReturn(updated);
        String json = STR."""
                {
                    "id":\{updated.id()},
